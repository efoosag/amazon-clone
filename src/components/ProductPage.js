        ...
        <div className="grid grid-cols-10 gap-2">
          ...
          <div className="col-span-2 p-4 bg-white rounded">
            ...
            <div className="text-base xl:text-lg">
              Quantity:
              <select className="bg-white p-2 border rounded-md focus:border-indigo-600 ml-2">
                <option>1</option>
                <option>2</option>
                <option>3</option>
                <option>4</option>
            ...
            <button type="button" className="bg-yellow-400 w-full p-3 text-xs xl:text-sm rounded hover:bg-yellow-500 mt-3">Add To Cart</button>
          </div>
        </div>
      </div>
    </div>
